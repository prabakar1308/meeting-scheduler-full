                        ...
                        try {
                            const findRes = await this.graph.findMeetingTimes(organizer, internal, {
                                ...
                                timeConstraint: {
                                    ...
                                    // Removed activityDomain: 'work' to allow IST evening hours
                                    // We filter for business hours (8 AM - 7 PM IST) in our own code below
                                },
                            ...
                            const businessHoursSlots = (findRes.meetingTimeSuggestions || [])
                                .filter((slot: any) => {
                                    ...
                                    // More flexible business hours: 8 AM to 7 PM IST
